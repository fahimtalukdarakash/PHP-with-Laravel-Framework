                ...
                <div class="card card-body">
                    ...
                    <form action="action.php" method="POST">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="first_number" value="<?php echo isset($_GET['first_number']) ? $_GET['first_number'] : ''; ?>"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-3">Second Number</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="second_number" value="<?php echo isset($_GET['second_number']) ? $_GET['second_number'] : ''; ?>"/>
                            </div>
                        </div>
                        <div class="row mb-3">
