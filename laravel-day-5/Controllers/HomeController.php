...
//        }
    ...
    public function stringWordAndCountCharGenerator()
    {
        return view('string-word-count');
    }
    public function wordCharCount(Request $request)
    {
        $this->data['word']=str_word_count($request->given_string);
        $this->data['character']=strlen($request->given_string);
        return back()->with([
            'word' => $this->data['word'],
